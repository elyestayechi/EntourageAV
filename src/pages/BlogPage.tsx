  ...
  return (
    <div className="min-h-screen bg-[#FAFAF9]">
      ...
      <section ref={heroRef} className="relative min-h-[50vh] flex items-center justify-center px-4 pt-32 pb-20">
        <FilmGrainTexture id="blogHeroGrain" opacity={0.04} withVignette={true} vignetteIntensity={0.15} />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {filteredPosts.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {blogPosts.map((post) => (  // Changed from filteredPosts to blogPosts to show all
                <Link
                  key={post.slug}
                  to={`/blog/${post.slug}`}
