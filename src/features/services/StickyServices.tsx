  ...
  return (
    <>
      ...
      >
        ...
        <FilmGrainTexture id="servicesGrain" opacity={0.04} withVignette={true} vignetteIntensity={0.12} />
              ...
              <div ref={imageContainerRef} className="lg:col-span-7 relative block mt-8 lg:mt-0" style={{ transformStyle: 'preserve-3d' }}>
                ...
                >
                  ...
                  >
                    ...
                    <FilmGrainTexture className="absolute inset-0 opacity-[0.025] pointer-events-none mix-blend-multiply z-40" />
                  </div>
                </div>
              </div>
            </div>
